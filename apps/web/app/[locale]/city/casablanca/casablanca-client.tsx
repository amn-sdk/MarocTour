...
export default function CasablancaPageClient() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Chargement des informations de Casablanca...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Impossible de charger les informations sur Casablanca.</p>
          <Link href="/map">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              backgroundImage: 'url(/images/cities/casablanca.jpg)',
      ...
      <section id="histoire" className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Histoire de Casablanca</h2>
            <p className="text-xl text-gray-600">
              De modeste port berbère à métropole cosmopolite, découvrez l'évolution fascinante de la capitale économique du Maroc
            </p>
            <div className="flex items-center justify-center gap-2 mt-4 text-sm text-gray-500">
              <Clock className="h-4 w-4" />
              <span>Lecture : environ 12 minutes</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-lg shadow-md p-6">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Aéroport :</strong> Aéroport Mohammed V (30 km du centre)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600">🚄</span>
                  <span><strong>Train :</strong> Liaisons fréquentes depuis Rabat (1h), Marrakech (3h)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600">🚗</span>
                  <span><strong>Route :</strong> Autoroute A3 depuis Rabat, A7 depuis Marrakech</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg shadow-md p-6">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="text-blue-600">🕌</span>
                  <span><strong>Mosquée Hassan II :</strong> Chef-d'œuvre architectural sur la mer</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600">🌊</span>
                  <span><strong>La Corniche :</strong> Front de mer, restaurants et plages</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-blue-600">🏛️</span>
                  <span><strong>Quartier des Habous :</strong> Architecture traditionnelle</span>
                </li>
              </ul>
            </div>
          </div>
